...
- 💼 **Experience** — 6+ years across Nepal, UK, and remote roles
...
![Hibernate](https://img.shields.io/badge/Hibernate-59666B?style=for-the-badge&logo=hibernate&logoColor=white)
...
![Livewire](https://img.shields.io/badge/Livewire-FB045D?style=for-the-badge&logo=laravel&logoColor=white)
...
![Postman](https://img.shields.io/badge/Postman-FF6365?style=for-the-badge&logo=postman&logoColor=white)
...
```
┌─────────────────────────────────────────────────────────────────────┐
│  📍 Contractor / Freelancer — Software Engineer                     │
│  📅 Jan 2023 – Present                                              │
│  💡 Full-time freelance development across web & API projects       │
├─────────────────────────────────────────────────────────────────────┤
│  📍 Gada Technology Pty Ltd — Software Engineer                     │
│  📅 Sep 2021 – Jan 2023  (1 yr 5 mos)                              │
│  💡 Full-time role — scalable application development               │
├─────────────────────────────────────────────────────────────────────┤
│  📍 IT Solutions — Software Engineer                                │
│  📅 Oct 2018 – Sep 2021  (3 yrs) · Lalitpur, Nepal · Hybrid        │
│  💡 Full-stack development across multiple enterprise projects      │
├─────────────────────────────────────────────────────────────────────┤
│  📍 Organic Ecommerce Ltd — Software Engineer (Freelance)          │
│  📅 Apr 2021 – Aug 2021  (5 mos) · Worcester, UK                   │
│  💡 Built an energy management system to automate power controls,  │
│     real-time emissions monitoring, and carbon reduction actions.   │
│  🔧 Laravel Nova · Vue.js · MySQL · Google Cloud IoT Core          │
└─────────────────────────────────────────────────────────────────────┘
```
